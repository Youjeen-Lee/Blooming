...
public class KakaoService implements IKakaoService{
    ...
    public String getAccessToken(String authorize_code) {
        ...
        try {
            ...
            sb.append("&client_id="+kakaoClientId); //  rest api key 작성
            sb.append("&redirect_uri="+kakaoRedirectURI); // 설정 url 작성
    ...
    public HashMap<String, Object> getUserInfo(String access_Token) {
        ...
        try {
            ...
            String email = CmmUtil.nvl(kakao_account.getAsJsonObject().get("email").getAsString());
