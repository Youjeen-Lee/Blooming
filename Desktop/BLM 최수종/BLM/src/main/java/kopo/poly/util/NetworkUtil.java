...
public class NetworkUtil {
     ...
     */
    public static String get(String apiUrl, @Nullable Map<String, String> requestHeaders) { //@Nullable을 앞에 붙이면 이 값이 와도 되고, 안와도 되고~
        HttpURLConnection con = connect(apiUrl);

        try {
            con.setRequestMethod("GET");

            // @NUllable에서 전송할 헤더 값이 존재하면, 해더 값 추가하기 (weather는 x, job은 존재)
