...
$(document).ready(function(){
    ...
    $(".pc_gnb_wrap .gnb_wrap .gnb_list").on("mouseenter focusin", function(){
        ...
        /* 전체메뉴닫기 버튼 활성화
        $(".btn_allmenu").addClass("open");
        $(".gnb .allmenu_wrap .btn_allmenu_close").css("display", "block");
        */
    });
    ...
    $(".pc_gnb_wrap .gnb_wrap .gnb_list").on("mouseleave focusout", function(){
        ...
        /* 전체메뉴닫기 버튼 비활성화
        $(".gnb .allmenu_wrap .btn_allmenu_close").css("display", "none");
    ...
    $(".allmenu_wrap .btn_allmenu").on("click", function(){
        ...
        $(".allmenu_wrap .btn_allmenu_close").focus();
    });
    ...
    $(".allmenu_wrap .btn_allmenu_close").on("click", function(){
        ...
        $(".allmenu_wrap .btn_allmenu").focus();
    })

    //전체메뉴 탭이동
    $(".allmenu_wrap .btn_allmenu_close").keydown(function(e) {
        if(e.keyCode == 9) {
            if($(window).width() > 1070){
                $(".allmenu_wrap .btn_allmenu").focus();
            }
    ...
    if($(window).width() < 1600){
        ...
        $(".btn_page_top").css({"right":"44%","margin-right":"-760px"})
    }
...
$(function() {
    // 230802 웹접근성 - 카드뉴스 포커스
    $(".result-card-box").each(function() {
        var tit  = $(this).find('a');
